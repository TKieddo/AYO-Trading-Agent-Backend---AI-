...
class FilterConfig:
    ...
    max_price_change_1h_pct: float = 8.0  # was 50 — reject already-running hyper moves
    min_price_usd: float = 0.0001
    max_price_usd: float = 100000
    exclude_patterns: tuple = (
        'DOWN', 'UP', 'BEAR', 'BULL',
        'PEPE', 'FLOKI', 'BONK', 'WIF', 'TRUMP', 'MEME', 'SHIB', 'DOGE', '1000',
    )
...
class PairFilter:
    ...
    BLACKLIST: Set[str] = {
        '1000PEPEUSDT', 'PEPEUSDT', 'FLOKIUSDT', 'BONKUSDT', 'WIFUSDT',
        'TRUMPUSDT', 'MEMEUSDT', 'SHIBUSDT', 'DOGEUSDT', '1000SATSUSDT',
    }
